...
if __name__ == '__main__':
    ...
    for item in dirListing:
        if ".PDF" in item: # Pesquisa pelos arquivos em PDF.
            if item.startswith(('SG_REF', 'SG_QUAL', 'SG_RNT')): # Determina o nome inicial do arquivo para buscar a variável correta a ser inserida na URL
                driver.get(url2 + '_'.join(item.split('_', 3)[1:3])) # Envia o valor da variável para a URL e realiza a busca dos anexos da SOB
